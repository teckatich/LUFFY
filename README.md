...
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/parallel_state.py:177** - : init using device mesh (not support hybrid engine now) Build the pipeline model-parallel groups.
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/parallel_state.py:249** - : check why True is not work in Ray trainer
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/parallel_state.py:253** - : init using device mesh (not support hybrid engine now) Build the pipeline model-parallel groups.
...
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_6_3/parallel_state.py:185** - : init using device mesh (not support hybrid engine now) Build the pipeline model-parallel groups.
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_6_3/parallel_state.py:257** - : check why True is not work in Ray trainer
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_6_3/parallel_state.py:262** - : init using device mesh (not support hybrid engine now) Build the pipeline model-parallel groups.
